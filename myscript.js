...
function enterRoute() {
  ...
  ourRequest.open(
    "GET",
    "https://nameless-tundra-18596.herokuapp.com/stops?route=" + route
  );
...
function getWaitTime(data) {
  ...
  waitTimes.innerHTML = " " + data.eta + " minutes.";
}
...
function enterStop() {
  ...
  stopURL =
    "https://nameless-tundra-18596.herokuapp.com/predict?stops=" +
    stopUniqueId[0];
